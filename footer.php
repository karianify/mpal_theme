...
<div class="clear"></div>
	...
	?>
<div id="mpal-footer" class="full-wrapper"> 
	<div class="mpal-wrap mpal-footer">
			<div class="footer-logo">
				<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/MortgagePal_Text_Reversed.png" />
			</div>
			
			<div class="mpal-footer-widgets">
				<div class="col4-item">
